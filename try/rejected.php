...
// pinapalabas lng nito lahat ng rejected
session_start();
...
$sql = "SELECT u.user_ID, u.user_firstname, u.user_lastname, u.datetime_user_created FROM user u INNER JOIN application_logs al ON u.user_ID = al.jobseeker_userid WHERE al.jobid = '".$request."' AND al.user_status = 'Rejected' ORDER BY al.datetime_apply DESC;";
